...
/**
 * Utility object to handle chrome's file (i.e loaded from chrome://)
 */
export const ChromeFilesUtils = (function() {
  let self = {
   getChromeUrl: null,
   readDirectory: null,
   parseJSON: null,
  ...
  */
  self.getChromeUrl = function(path) {
   ...
   * @return {Promise}
   */
  self.readDirectory = function(chromeUrl) {
    if (!chromeUrl) {
   ...
   * @return {Promise}
   */
  self.parseJSON = function(chromeUrl) {
